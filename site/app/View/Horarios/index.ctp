<p><h1>Selecione o seu curso para ver o seu horário e disciplinas</h1></p>
...
<ul>
		                      ...
		                      <li><a href="http://localhost/ufrpe_search/site/horarios/horario_licenciatura_matematica">Lic. em Matemáca</a></li>
		                      ...
		                      <li><a href="http://localhost/ufrpe_search/site/horarios/horario_zootecnia">Zootecnia</a></li>
		                       <li><a href="http://localhost/ufrpe_search/site/horarios/horario_zootecnia">Turma Única (junção de vários cursos em uma só turma)</a></li>
</ul>